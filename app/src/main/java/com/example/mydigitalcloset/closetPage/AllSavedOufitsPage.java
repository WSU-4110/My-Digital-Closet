...
public class AllSavedOufitsPage extends AppCompatActivity {
    ...
    // private View bgiphone_14__1_ek2;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // bgiphone_14_1_ek2 = (View) findViewById(R.id._bgiphone_14__1_ek2);
        ...
        outfit = (TextView) findViewById(R.id.campus_green_sweater_and_jeans_skirt);
    ...
    public void openOutfit(){
        ...
        AlertDialog alertBuilder = new AlertDialog.Builder(this)
                .setTitle("Confirm Re-Direct")
                .setMessage("Re-direct to Saved Outfit page")
